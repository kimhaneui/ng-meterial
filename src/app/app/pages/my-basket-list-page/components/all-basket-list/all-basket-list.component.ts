...
@Component({
    selector: 'app-all-basket-list',
    templateUrl: './all-basket-list.component.html',
    styleUrls: ['./all-basket-list.component.scss']
})
export class AllBasketListComponent extends BaseChildComponent implements OnInit, OnDestroy {
...
//   switch (cate) {
//     case 'IC01':
//       this.pagePath = '/my-reservation-flight-booking/';
//       break;
//     case 'IC02':
//       this.pagePath = '/my-reservation-hotel-booking/';
//       break;
//     case 'IC03':
//       this.pagePath = '/my-reservation-rent-booking/';
//       break;
//     case 'IC04':
//       this.pagePath = '/my-reservation-activity-booking/';
//       break;
//     default:
//       this.pagePath = '/my-reservation-flight-booking/';
//       break;
