...
@Component({
    selector: 'app-notice-list-flight',
    templateUrl: './notice-list-flight.component.html',
    styleUrls: ['./notice-list-flight.component.scss']
})
export class NoticeListFlightComponent extends BaseChildComponent implements OnInit, OnDestroy {
    ...
    async callNoticeListApi() {
        ...
        return this.apiMypageService.POST_MYPAGE_NOTICE($rq)
            .toPromise()
            .then((res: any) => {
                console.info('[공지사항 항공리스트 > res]', res);
