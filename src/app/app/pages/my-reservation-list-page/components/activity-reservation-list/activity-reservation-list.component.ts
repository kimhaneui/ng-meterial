...
@Component({
    selector: 'app-activity-reservation-list',
    templateUrl: './activity-reservation-list.component.html',
    styleUrls: ['./activity-reservation-list.component.scss']
})
export class ActivityReservationListComponent extends BaseChildComponent implements OnInit, OnDestroy {
    ...
    async increase() {
        ...
        if (this.totalCount !== 0 && this.totalCount < this.pageCount) {  // totalCount != 0 (첫번째 api 호출)이 아니고
            ...
            this.result.result.list.forEach(() => {
