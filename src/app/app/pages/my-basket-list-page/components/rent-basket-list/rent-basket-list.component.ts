...
@Component({
    selector: 'app-rent-basket-list',
    templateUrl: './rent-basket-list.component.html',
    styleUrls: ['./rent-basket-list.component.scss']
})
export class RentBasketListComponent extends BaseChildComponent implements OnInit {
