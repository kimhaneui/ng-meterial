...
@Component({
    selector: 'app-notice-list-hotel',
    templateUrl: './notice-list-hotel.component.html',
    styleUrls: ['./notice-list-hotel.component.scss']
})
export class NoticeListHotelComponent extends BaseChildComponent implements OnInit, OnDestroy {
    ...
    async callNoticeListApi() {
        ...
        return this.apiMypageService.POST_MYPAGE_NOTICE($rq)
            .toPromise()
            .then((res: any) => {
                console.info('[공지사항 호텔리스트 > res]', res);
