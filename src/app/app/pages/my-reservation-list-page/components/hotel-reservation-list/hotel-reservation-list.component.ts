...
@Component({
    ...
    styleUrls: ['./hotel-reservation-list.component.scss'],
})
export class HotelReservationListComponent extends BaseChildComponent implements OnInit, OnDestroy {
    ...
    async callReservationtListApi(cate) {
        const $rq = {
            ...
            condition: {
                ...
                itemCategoryCode: 'IC02', // 호텔리스트라서 itemCategoryCode가 IC02
