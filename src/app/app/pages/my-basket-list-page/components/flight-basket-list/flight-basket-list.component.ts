...
@Component({
    selector: 'app-flight-basket-list',
    templateUrl: './flight-basket-list.component.html',
    styleUrls: ['./flight-basket-list.component.scss']
})
export class FlightBasketListComponent extends BaseChildComponent implements OnInit {
