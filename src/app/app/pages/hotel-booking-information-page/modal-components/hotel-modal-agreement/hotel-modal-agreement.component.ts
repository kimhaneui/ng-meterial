...
@Component({
    selector: 'app-hotel-modal-agreement',
    templateUrl: './hotel-modal-agreement.component.html',
    styleUrls: ['./hotel-modal-agreement.component.scss']
})
export class HotelModalAgreementComponent extends BaseChildComponent implements OnInit, OnDestroy {
    storeId: any;
