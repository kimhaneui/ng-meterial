...
@Component({
    selector: 'app-hotel-basket-list',
    templateUrl: './hotel-basket-list.component.html',
    styleUrls: ['./hotel-basket-list.component.scss']
})
export class HotelBasketListComponent extends BaseChildComponent implements OnInit {
    ...
    goBookingInformation() {
        ...
        const cityGubun = this.comService.getDestinationCodeName(this.hotelRoomtypeRq.cityGubun);
