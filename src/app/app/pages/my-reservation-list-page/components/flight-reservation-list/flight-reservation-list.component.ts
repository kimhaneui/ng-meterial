...
export class FlightReservationListComponent extends BaseChildComponent implements OnInit, OnDestroy {
    ...
    async callReservationtListApi(cate) {
        const $rq = {
            ...
            condition: {
                ...
                itemCategoryCode: 'IC01', // 항공리스트라서 itemCategoryCode가 IC01
