...
@Component({
    selector: 'app-notice-list-rent',
    templateUrl: './notice-list-rent.component.html',
    styleUrls: ['./notice-list-rent.component.scss']
})
export class NoticeListRentComponent extends BaseChildComponent implements OnInit, OnDestroy {
    ...
    async callNoticeListApi() {
        ...
        return this.apiMypageService.POST_MYPAGE_NOTICE($rq)
            .toPromise()
            .then((res: any) => {
                console.info('[공지사항 렌터카리스트 > res]', res);
