...
export class NoticeListComponent extends BaseChildComponent implements OnInit, OnDestroy {
    ...
    async callNoticeListApi() {
        ...
        delete $rq.condition.postCategoryCode;
        ...
        return this.apiMypageService.POST_MYPAGE_NOTICE($rq)
            .toPromise()
            .then((res: any) => {
                console.info('[공지사항 전체리스트 > res]', res);
